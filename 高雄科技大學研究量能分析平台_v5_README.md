...
- 合作分析摘要已由三張資料表改為「合作研究結構桑基圖」，整合同一份 detailed Summary 中的學科領域、Top Keyphrases 與合作來源/作者/期刊資料；左側為主要學校與合作類型，中間為資料類別，右側顯示各類前幾名項目。桑基圖會跟隨 General 上方 `主要學校` 篩選與合作類型同步重畫。
