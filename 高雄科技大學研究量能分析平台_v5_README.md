...
## 視覺調整
- 背景已改為深色研究漂浮字樣風格，文字改為全英文並自導覽按鈕下方開始散落，中央閱讀區保留乾淨空間；目前增加更多研究治理、資料、專利、永續與 AI 相關字詞，並更分散地配置於上中下與左右外圍背景。背景字樣具備慢速漂浮、滑鼠視差、近距離跟隨、頁面捲動視差與偶發高亮效果，文字透明度已提高，且位置已縮回瀏覽器可視範圍內，讓背景在不干擾閱讀的前提下保有動態感。
